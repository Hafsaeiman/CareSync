    ...
    .then((data) => {
      ...
      if (Array.isArray(data) && data.length > 0) {
        ...
        const formattedAppointments = data.map((item) => ({
          ...
          doctor: item.doctorName || form.doctor,
...
<div className="form-group">
  ...
  />
            ...
            <button type="submit" className="submit-btn">Book Appointment <span className="btn-arrow">→</span>
            </button>
          </form>
        </div>
        {/* RIGHT — Contact Info */}
