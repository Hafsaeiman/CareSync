        ...
        <div className="hero-content">
          <div className="hero-text">
            ...
            {/* <div className="hero-badges">
              <span className="hero-badge">✦ ISO Certified</span>
              <span className="hero-badge">✦ 150+ Specialists</span>
              <span className="hero-badge">✦ 24/7 Emergency</span>
            </div> */}
        ...
        <div className="chat-widget">
          ...
          <div className="chat-body">
            <div className="chat-message">
              <strong>Assistant:</strong> Hello! How can we help you today?
            </div>
          </div>
